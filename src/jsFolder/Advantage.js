        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div
              ...
              data-aos-delay={100}
            >
              <div className="service2 horizontal d-flex">

                <div className="service-icons color-1  m-1  shadow-lg rounded-3">
                  <svg
            ...
            >
              <div className="service2 horizontal d-flex">
                <div className="service-icons color-2  m-1 shadow-lg rounded-3">
                  <svg
            ...
            >
              <div className="service2 horizontal d-flex">
                <div className="service-icons color-3  m-1 shadow-lg rounded-3">
                  <svg
