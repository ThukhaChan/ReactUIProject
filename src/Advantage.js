              ...
              <div className="service horizontal d-flex">
                <div className="service-icon color-1 mb-4">
                  ...
                  >
                   ...
                   <img src={cap1} alt="Image" className="img-fluid rounded-5" width={'75px'} height={'75px'}/>
                </div>
              ...
              <div className="service horizontal d-flex">
                <div className="service-icon color-2 mb-4">
                  ...
                  >
                   ...
                   <img src={cap4} alt="Image" className="img-fluid rounded-5" width={'75px'} height={'75px'}/>
                </div>
                <div className="service-contents">
